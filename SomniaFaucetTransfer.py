...
def activity(bot: Bot):
    ...
    bot.ads.page.get_by_role('button', name='0.001').hover(timeout=5000)
    bot.ads.page.get_by_role('button', name='0.001').click()
    random_sleep(3, 5)

    bot.ads.page.get_by_role('button', name='Random Address').hover(timeout=5000)
    bot.ads.page.get_by_role('button', name='Random Address').click()
    random_sleep(3, 5)

    bot.ads.page.get_by_role('button', name='Send STT').hover(timeout=5000)
